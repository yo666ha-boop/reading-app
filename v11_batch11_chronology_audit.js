'use strict';
const fs=require('fs');
// Batch11 chronology gate. Load the complete unregistered authoring stack, final word-band repairs, and only human-verified Japanese glosses.
