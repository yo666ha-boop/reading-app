...
// but allow every rendered child to shrink/wrap inside its panel.
(function installV10MobileLayoutGuard(){
  ...
  style.textContent = `
    html,body,.wrap,.panel,.tabpage,.row,.field,.controlbar,.q,.slash,.evidence,.meta,.notice,.fail{max-width:100%;min-width:0}
    .panel *{min-width:0}
