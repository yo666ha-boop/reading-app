...
async function waitFor(fn,ms=20000){const start=Date.now();while(Date.now()-start<ms){if(fn())return;await new Promise(r=>setTimeout(r,50))}throw new Error('semantic runtime load timeout')}
(async()=>{
