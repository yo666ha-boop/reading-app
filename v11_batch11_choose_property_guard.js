...
function buildFrozen(){
  ...
  if(typeof window.V11_GET_BATCH11_VERIFIED_SUPPORT_SNAPSHOTS==='function'){
    for(const s of window.V11_GET_BATCH11_VERIFIED_SUPPORT_SNAPSHOTS()||[]){
...
function installRegistryGuards(){
  ...
  const state={found,guarded,expected:frozen.size,pass:found===frozen.size&&guarded===frozen.size,authoritativeSnapshot:true,version:'20260831-b11-registry-support-guard-r9-authoritative-snapshot'};
...
window.V11_BATCH11_CHOOSE_PROPERTY_GUARD={installed:true,snapshotsAtLoad:frozen.size,passagePropertyGuard:true,registryInstaller:true,delayedSnapshotValidation:true,authoritativeSnapshot:true,defensiveClone:true,version:'20260831-b11-registry-support-guard-r9-authoritative-snapshot'};
})();
