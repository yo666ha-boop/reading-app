...
(async()=>{try{for(const f of files)await load(f);if(!window.V11_BATCH06_LOADED)throw new Error('Batch06 registration did not complete');await load('v11_batch07_bootstrap.js');window.V11_BATCH06_BOOTSTRAP_STATE={version:'20260829-final-b07-chain',files:files.length+1,loaded:true,total:window.V11_BATCH06_STATE&&window.V11_BATCH06_STATE.totalWithBaseline};if(typeof window.render==='function')window.render();}catch(e){window.V11_BATCH06_BOOTSTRAP_ERROR=String(e&&e.stack||e);console.error(e);throw e;}finally{window.V11_BATCH06_BOOTSTRAP_LOADING=false;}})();
})();
