...
// Batch17 marker: authoritative scan loads every bounded local annotation through proper-name batch5 and notes batch17.
...
patch(
  ...
  "    await waitFor(() => w.V10_RUNTIME_LOAD_PROGRESS === 'complete' || !!w.V10_RUNTIME_LOAD_ERROR, 90000, 'authoritative final runtime terminal state');\n    assert(w.V10_RUNTIME_LOAD_PROGRESS === 'complete' && !w.V10_RUNTIME_LOAD_ERROR, `authoritative runtime load failed: progress=${w.V10_RUNTIME_LOAD_PROGRESS} error=${w.V10_RUNTIME_LOAD_ERROR}`);\n    for (const f of ['v10_passage_local_proper_names_batch1.js','v10_passage_local_proper_names_batch2.js','v10_passage_local_proper_names_batch3.js','v10_passage_local_proper_names_batch4.js','v10_passage_local_proper_names_batch5.js','v10_passage_local_notes_batch2.js','v10_passage_local_notes_batch3.js','v10_passage_local_notes_batch4.js','v10_passage_local_notes_batch5.js','v10_passage_local_notes_batch6.js','v10_passage_local_notes_batch7.js','v10_passage_local_notes_batch8.js','v10_passage_local_notes_batch9.js','v10_passage_local_notes_batch10.js','v10_passage_local_notes_batch11.js','v10_passage_local_notes_batch12.js','v10_passage_local_notes_batch13.js','v10_passage_local_notes_batch14.js','v10_passage_local_notes_batch15.js','v10_passage_local_notes_batch16.js','v10_passage_local_notes_batch17.js','v10_grammar_vocab_final_sync.js']) {\n      if (!fs.existsSync(f)) throw new Error('missing bounded passage-local runtime file: '+f);\n      w.eval(fs.readFileSync(f,'utf8'));\n    }\n    await new Promise(r => setTimeout(r, 250));\n    browserErrors.length = 0;",
  'authoritative runtime completion + bounded local annotations + final grammar/vocab sync'
);
