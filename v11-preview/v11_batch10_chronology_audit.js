'use strict';
const fs=require('fs');
// Batch10 chronology gate. Load the final human-reviewed stack before checking vocab/grammar chronology.
// Registration remains false until downstream duplicate/UI/print/runtime gates also pass.
