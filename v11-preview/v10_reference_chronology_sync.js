...
(function(g){
  ...
  const legacyGetReady6Sentences=[
    'I had lunch at the zoo.','I ate pizza.','I saw a panda.','I saw a monkey, too.','I saw a tiger.','I saw a rabbit.','I saw a bear, too.','I like the panda and the monkey.','I like the tiger, too.','I like the zoo.'
  ];
  const chronologyGetReady6Rows=[
    {en:'I eat lunch.',jp:'私は昼食を食べます。'},
    {en:'I am / at the zoo.',jp:'私はいます / 動物園に'},
    {en:'I like the panda.',jp:'私はパンダが好きです。'},
    {en:'I like the monkey, / too.',jp:'私はサルが好きです / 〜もまた'},
