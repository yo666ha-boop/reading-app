...
(function(){
 ...
 setAudit(d,'Unit 6-3',[
  {en:'This is a cushion.',jp:'これはクッションです。'},{en:'It is a prop / in the show.',jp:'それは小道具です / そのショーで使う'},{en:'This is a towel.',jp:'これはタオルです。'},{en:'It is a prop, / too.',jp:'それは小道具です / 〜もまた'},{en:'I use the cushion first.',jp:'私は最初にクッションを使います。'},{en:'Then I use the towel.',jp:'それからタオルを使います。'},{en:'I wear casual clothes / in the show.',jp:'私はカジュアルな服を着ます / そのショーで'},{en:'Which do you like, / the cushion / or the towel?',jp:'どちらが好きですか / クッション / それともタオルが'},{en:'I like the cushion.',jp:'私はクッションが好きです。'},{en:'The cushion / and the towel are different.',jp:'クッション / そしてタオルは違います'},{en:'The show is great.',jp:'そのショーはすばらしいです。'}
 ],57);
 setAudit(d,'Unit 7-1',[
