(function repairV11Batch07GrammarChronology(){
'use strict';
...
replaceRow('V11-B07-G1-002','Aya moved her bag and told him the seat was free.',"Aya moved her bag and said, 'This seat is free.'",'彩はかばんを動かし、「この席は空いています」と言いました。');
replaceRow('V11-B07-G1-002','Aya learned that a saved seat should be opened when the plan changes.','Aya learned a simple rule: open a saved seat when the plan changes.','彩は「予定が変わったら取っておいた席を空ける」という簡単なルールを学びました。');
replaceRow('V11-B07-G1-003','The note belonged to her, and she was happy to get it back.','The note belonged to her, and she smiled when it came back.','メモはその生徒のもので、戻ってくると笑顔になりました。');
replaceRow('V11-B07-G1-004','Two other students had also arrived early because they trusted the classroom clock.','They trusted the classroom clock, so two other students had also arrived early.','二人のほかの生徒も教室の時計を信じ、早く来ていました。');
replaceRow('V11-B07-G1-005','Their note said they should have fruit because one player could not eat the crackers.',"Their note said, 'Fruit for our team,' and one player did not eat the crackers.",'メモには「私たちのチームには果物」とあり、一人の選手はそのせんべいを食べませんでした。');
replaceFields('V11-B07-G1-005','The card was marked _____','The card said _____');
replaceRow('V11-B07-G1-006','Every student had one job, but Sora could not find his name.','Every student had one job, but Sora did not find his name.','全員に一つ係がありましたが、空は自分の名前を見つけませんでした。');
replaceRow('V11-B07-G1-006','The name was missed when the clean copy was written.',"The writer missed Sora's name on the clean copy.",'清書した人が空の名前を書き落としていました。');
replaceRow('V11-B07-G1-008','After one week, he could reach the gym without help.','After one week, he reached the gym without help.','一週間後、助けなしで体育館へ行けました。');
replaceRow('V11-B07-G1-008','For Leo, the easiest route to remember was better than the shortest route.','For Leo, the long route was easy to remember, and it worked well.','レオには、長い方の道が覚えやすく、うまく使えました。');
replaceRow('V11-B07-G1-010','A friend sent them a photo of the bus stop.','A friend sent a photo of the bus stop to Nina and Haru.','友達がニナと春にバス停の写真を送りました。');
replaceRow('V11-B07-G1-013','He did not push harder because he did not know the cause.','He did not know the cause, so he did not push harder.','原因が分からなかったので、さらに強く押しませんでした。');
replaceFields('V11-B07-G1-013','They did not try to repair the door.','They did not repair the door.');
replaceRow('V11-B07-G1-014','Most days it worked, but busy sports days were different.','On many days it worked, but busy sports days were different.','多くの日はうまくいきましたが、忙しい運動部の日は違いました。');
replaceRow('V11-B07-G1-014','She put the phone across the room, so she had to stand up.','She put the phone across the room. She stood up and stopped it.','携帯電話を部屋の反対側に置きました。止めるときは立ち上がりました。');
replaceFields('V11-B07-G1-015','That gave them a better place to search.','That showed a better place to search.');
replaceRow('V11-B07-G1-016','The next class could not tell which box or what to do with it.','The next class did not understand the box or the action.','次のクラスは、どの箱のことか、何をするのか理解できませんでした。');
...
replaceRow('V11-B07-G2-008','The symbols looked clear to the students who made the map.','The student makers understood the symbols clearly.','地図を作った生徒たちは記号をよく理解していました。');
replaceRow('V11-B07-G2-009','It also asked whether they walked at least once a week, not how they traveled every day.',"It asked one question: 'Do you walk at least once a week?' It did not ask about every day.",'質問は「週一回以上歩きますか」という一つだけで、毎日の通学方法は聞いていませんでした。');
...
replaceFields('V11-B07-G3-013','The data made us question our original plan.','The data changed our view of the original plan.');
replaceRow('V11-B07-G3-003','We also marked the bridge and library because they helped people see that the location was the same.','The bridge and library helped people see the same location, so we marked them too.','橋と図書館は同じ場所だと分かる手がかりになったので、それらも地図に示しました。');
replaceRow('V11-B07-G3-003','During a test walk, one student said the two names had made her imagine two different streets.',"During a test walk, one student said, 'I imagined two different streets from the two names.'",'試し歩きで一人の生徒は「二つの名前から別々の通りを想像しました」と話しました。');
replaceRow('V11-B07-G3-006','Some members said the phone tree was too slow to use by itself.','Some members said the phone tree alone was slow.','電話連絡網だけでは遅いという部員もいました。');
