...
window.V11_BATCH09_GLOSS_APPLY_R2_STATE={version:'20260829-r5-gap',passages:ps.length,converted,missing:missing.length,missingWords:[...new Set(missing.map(x=>x[1]))].sort(),registered:false};
