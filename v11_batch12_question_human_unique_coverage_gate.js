...
function syncStage(stage,x){if(stage==='R7')return syncR7(x);if(stage==='R8')return syncR8(x);if(stage==='R11')return syncR11(x);if(stage==='R12')return syncR12(x);return x;}
