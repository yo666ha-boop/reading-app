...
(function(){
 ...
 const next=()=>{
  ...
  load(src,()=>{try{const obj=getObj()||{};window.V10_INTERACTION_META=target;Object.assign(target,obj)}catch(e){window.V10_RUNTIME_LOAD_ERROR='merge:'+src+':'+String(e&&e.message||e)}next();});
 };
 next();
})();