...
(function(){
 ...
 setAudit(n1,'Unit 8-1',[
  ...
  {en:'I want / to teach children / someday.',jp:'私は望んでいます / 子どもたちに教えることを / いつか'},
 ...
 setAudit(n1,'Unit 8-3',[
  ...
  {en:'A group is / in the village.',jp:'グループがあります / 村の中に'},
  {en:'They want / to build a well.',jp:'彼らは望んでいます / 井戸を作ることを'},
 ...
 setAudit(n1,'Unit 9-1',[
  ...
  {en:'The mountain is beautiful.',jp:'その山は美しいです。'},
  {en:'After snowboarding, / I went back home.',jp:'スノーボードのあと / 私は家へ戻りました'},
  {en:'I want / to go back / to the mountain / someday.',jp:'私は望んでいます / また行くことを / その山へ / いつか'},
 ...
 setAudit(n1,'Unit 9-3',[
  ...
  {en:'I want / to spend New Year’s Day / with my grandparent / again.',jp:'私は望んでいます / 元日を過ごすことを / 祖父母と / また'}
 ],66);
 ...
 setAudit(n1,'Unit 10-2',[
  ...
  {en:'I remember the contest, / too.',jp:'私はそのコンクールを思い出します / 〜もまた'},
 ...
 setAudit(s2,'PROGRAM 1-1',[
  {en:'I have a special plan.',jp:'特別な計画があります。'},
  ...
  {en:'I want / to see my friends / again.',jp:'私は望んでいます / 友達に会うことを / また'},
