...
if(!st||st.extraPassages!==100||totalWithBaseline!==268)throw new Error('Batch02 runtime totals invalid '+JSON.stringify(st));
window.V11_BATCH02_STATE={...st,totalWithBaseline,batch02Passages:50,registered:true,version:'20260828-final'};
