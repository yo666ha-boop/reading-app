...
const SUN_FILES=['v10_data_sunshine_g1.js','v10_data_sunshine_g1_program1.js'];
const NH_FILES=[
...
if(Object.keys(sun).length!==8) fail(`Sunshine count expected 8, got ${Object.keys(sun).length}`,errors);
