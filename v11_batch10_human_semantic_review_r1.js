...
replaceRow('V11-B10-G2-001','She explained the problem. A noisy hall caused trouble for some visitors, and poor hearing caused the same trouble.','She explained the problem. Noise made the interviews hard to hear, and some visitors also needed written words.','彼女は問題を説明しました。騒音でインタビューが聞き取りにくくなり、文字での情報を必要とする来場者もいました。','Removed stiff causal wording and made the accessibility need explicit without changing the story logic.');
