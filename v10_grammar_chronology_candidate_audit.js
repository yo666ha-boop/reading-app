...
function scan(text,where,out){
  ...
  const rules=[
    ...
    ['MODAL_CAN_COULD_MAY_MUST_SHOULD',/\b(?:can|could|may|might|must|should)\s+(?:not\s+)?[a-z]+\b/i],
    ...
    ['TO_INFINITIVE',/\b(?:want|need|hope|plan|decide|try|learn|start|begin|like|love|would like|ask|tell|choose|promise|agree|expect|wish|help)\s+(?:me|you|him|her|us|them\s+)?to\s+[a-z]+\b|\b(?:happy|glad|sorry|surprised|excited|ready|easy|hard|difficult|important|necessary|possible|good|nice)\s+to\s+[a-z]+\b/i],
