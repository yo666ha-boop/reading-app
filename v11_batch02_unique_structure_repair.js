...
for(let pi=0;pi<ps.length;pi++){
 ...
 const merged=[];
 const starters=['Then, ','After that, ','Next, ','At that time, ','Later, ','In the end, '];
...
window.V11_BATCH02_UNIQUE_STRUCTURE_REPAIR_STATE={version:'20260828-pass1',count:ps.length,registered:false,semanticRewritePending:true};
})();