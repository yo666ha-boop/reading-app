...
(async()=>{
 ...
 // reintroduce pre-chronology rows (for example SS2 PROGRAM 2-1 "bring" and NH2 Unit 2-2 "give").
 // The normal correction interval can already have stopped once the real runtime reaches
