...
for(const f of ['v11_batch04_passages_draft_g1.js','v11_batch04_passages_draft_g2.js','v11_batch04_passages_draft_g3.js','v11_batch04_length_repair.js','v11_batch04_length_repair_r2.js'])vm.runInContext(fs.readFileSync(f,'utf8'),sandbox,{filename:f});
...
const out={generatedAt:new Date().toISOString(),count:ps.length,registered:false,currentRuntimeTotal:318,targetRuntimeTotal:368,lengthRepair:sandbox.window.V11_BATCH04_LENGTH_REPAIR_STATE||null,lengthRepairR2:sandbox.window.V11_BATCH04_LENGTH_REPAIR_R2_STATE||null,problems,byGrade,finalPass:ps.length===50&&problems.length===0};
