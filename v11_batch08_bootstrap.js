...
(async()=>{try{for(const f of files)await load(f);if(!window.V11_BATCH08_LOADED)throw new Error('Batch08 registration did not complete');window.V11_BATCH08_BOOTSTRAP_STATE={version:'20260829-human-r1',files:files.length,loaded:true,total:window.V11_BATCH08_STATE&&window.V11_BATCH08_STATE.totalWithBaseline};if(typeof window.render==='function')window.render();}catch(e){window.V11_BATCH08_BOOTSTRAP_ERROR=String(e&&e.stack||e);console.error(e);throw e;}finally{window.V11_BATCH08_BOOTSTRAP_LOADING=false;}})();
})();
