...
'change':'変える・変化','changing':'変えている','easier':'より簡単な','idea':'考え','moved':'動かした・移動した','partner':'相手','photo':'写真','photos':'写真','project':'課題','put':'置いた','repeating':'繰り返して','solved':'解決した','used':'使った',
...
'avoid':'避ける','began':'始めた','clear':'はっきりした','clearly':'はっきりと','laughed':'笑った','line':'線','lines':'線','match':'合う','part':'部分','point':'点・要点','similar':'似ている','house':'家','immediately':'すぐに','leave':'去る','note':'メモ','yet':'まだ',
