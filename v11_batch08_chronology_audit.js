...
const loader=`function loadDraft(){const sandbox={window:{},console};sandbox.globalThis=sandbox.window;vm.createContext(sandbox);for(const f of ['v11_batch08_passages_draft_g1.js','v11_batch08_passages_draft_g2.js','v11_batch08_passages_draft_g3.js','v11_batch08_g3_length_repair.js','v11_batch08_grammar_repair.js','v11_batch08_grammar_repair_r2.js','v11_batch08_grammar_repair_r3.js','v11_batch08_vocab_repair.js','v11_batch08_gloss_apply.js'])vm.runInContext(fs.readFileSync(f,'utf8'),sandbox,{filename:f});const ps=[...(sandbox.window.V11_BATCH08_G1_DRAFTS||[]),...(sandbox.window.V11_BATCH08_G2_DRAFTS||[]),...(sandbox.window.V11_BATCH08_G3_DRAFTS||[])];if(ps.length!==50)throw Error('Batch08 draft not 50');if(!sandbox.window.V11_BATCH08_GLOSS_APPLY_STATE||sandbox.window.V11_BATCH08_GLOSS_APPLY_STATE.unresolved.length)throw Error('Batch08 final gloss apply incomplete');return JSON.parse(JSON.stringify(ps));}`;
