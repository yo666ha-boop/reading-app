...
try{
 ...
 const out={generatedAt:new Date().toISOString(),passages:ps.length,lengthIssues,structureIssues,translationIssues,questionIssues,temporaryGlossPassages:[...new Set(temporaryGlossPassages)],temporaryGlossCount:temporaryGlossCountByPassage.reduce((a,x)=>a+x.count,0),temporaryGlossCountByPassage,noteResidualState:s.window.V11_BATCH05_NOTE_PREFINAL_RESIDUAL_STATE||null,noteFinalizeState:s.window.V11_BATCH05_NOTE_FINALIZE_STATE||null,translationSyncState:s.window.V11_BATCH05_TRANSLATION_SYNC_STATE||null,questionRegenState:s.window.V11_BATCH05_QUESTION_REGEN_STATE||null,registrationReady:false};
