...
ORDER=["Winpass"]*717+["実力錬成"]*237+["Standard"]*317
OFFSETS={"Winpass":0,"実力錬成":717,"Standard":954}
...
def validate(records:list[dict],manifest:dict)->dict:
    ...
    full_shas=[]; extraction_fps=[]; counts={k:0 for k in EXPECTED_COUNTS}
    for i,r in enumerate(records):
        ...
        local=i-OFFSETS[source] if source in OFFSETS else None
