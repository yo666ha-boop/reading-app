...
def parent(**overrides):
    row={"id":"P-IQR-001","question":"データ 2、4、5、7、9、10、12、15 の四分位範囲を求めなさい。","answer":"6","figure_refs":[],"choices":None}
...
def main():
    ...
    bad=[
      ...
      parent(question="データ 2、4、5、7、9、10、12、15 の中央値と四分位範囲を求めなさい。",answer="6"),
      parent(question="箱ひげ図を見て四分位範囲を求めなさい。",answer="6"),
    ]
    for row in bad:
