...
def main() -> None:
    ...
    parent["id"] = "U-CIRCLE-AREA"
    parent["question"] = "半径3cmの円の面積を、円周率を3.14として求めなさい。"
    parent["answer"] = "28.26cm²"
    parent["choices"] = []
    parent["figure_refs"] = []
    ...
    assert reason.startswith("specialized:circle_area_pi_3_14:")
    ...
    print("PASS_CIRCLE_AREA_UNIFIED_ADAPTER_PARENT_SHA_METADATA_AUDIT_AND_INDEPENDENT_RECALCULATION")
