...
def main() -> None:
    ...
    parent["id"] = "U-CONE-SURF-L"
    parent["question"] = "半径3cm、表面積150.72cm²の円すいがあります。円周率を3.14として母線の長さを求めなさい。"
    parent["answer"] = "13cm"
    parent["choices"] = None
    parent["figure_refs"] = []
    ...
    assert reason.startswith("specialized:cone_volume_pi_3_14:cone_slant_from_surface_area_pi_3_14_exact")
    ...
    for row, evidence in zip(rows, prov):
        ...
        assert "cone_slant_from_surface_area_exact_inverse_and_recomposition" in evidence["verification_evidence"]
    print("PASS_CONE_SLANT_FROM_SURFACE_AREA_UNIFIED_ADAPTER")
