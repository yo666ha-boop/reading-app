...
def main():
    w=[row("Winpass",i) for i in range(717)]; j=[row("実力錬成",i) for i in range(237)]; s=[row("Standard",i) for i in range(317)]; base=w+j+s
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        out=m.load_and_validate(bp,mp,lp); assert out["mode"]=="REBUILT_1271_DYNAMIC_IMMUTABLE_BASE" and out["rebuilt_base_sha256"]==anchor
    ...
    print("PASS_REBUILT_1271_DYNAMIC_ANCHOR_EXPANDED_VALIDATOR_NO_OLD_1231_DEPENDENCY")
