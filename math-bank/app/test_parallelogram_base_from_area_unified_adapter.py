...
def main():
    parent=copy.deepcopy(make_base()[0]); parent["id"]="U-PARA-B"
    parent["question"]="高さ6cm、面積48cm²の平行四辺形の底辺を求めなさい。"; parent["answer"]="8cm"
    ...
    rows,prov,reason=generate_parent(parent,3,NOW); assert reason.startswith("specialized:parallelogram_area:parallelogram_base_from_area_exact")
    ...
    print("PASS_PARALLELOGRAM_BASE_FROM_AREA_UNIFIED_CONTRACT")
