...
def main():
    ...
    parent["id"]="U-TRI-BASE-FROM-AREA"
    parent["question"]="高さ6cm、面積24cm²の三角形の底辺を求めなさい。"
    parent["answer"]="8cm"; parent["choices"]=[]; parent["figure_refs"]=[]
    ...
    assert reason.startswith("specialized:triangle_area:triangle_base_from_area_exact")
    ...
    print("PASS_TRIANGLE_BASE_FROM_AREA_UNIFIED_PARENT_SHA_METADATA_AUDIT_AND_IDENTITY")
