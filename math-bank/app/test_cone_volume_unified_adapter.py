...
def main() -> None:
    ...
    parent["id"] = "U-CONE-VOL"
    parent["question"] = "半径3cm、高さ6cmの円すいの体積を、円周率を3.14として求めなさい。"
    parent["answer"] = "56.52cm³"
    parent["choices"] = []
    parent["figure_refs"] = []
    ...
    assert reason.startswith("specialized:cone_volume_pi_3_14:")
    ...
    assert all("半径3cm、高さ6cm" not in row["question"] for row in rows)
    print("PASS_CONE_VOLUME_UNIFIED_ADAPTER_PARENT_SHA_METADATA_AUDIT_AND_INDEPENDENT_RECALCULATION")
