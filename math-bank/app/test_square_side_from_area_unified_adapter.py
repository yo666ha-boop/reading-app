...
def main():
    ...
    parent["id"]="U-SQ-SIDE-A"
    parent["question"]="面積64cm²の正方形の1辺の長さを求めなさい。"
    parent["answer"]="8cm"
    parent["choices"]=None
    parent["figure_refs"]=[]
    ...
    assert reason.startswith("specialized:square_area:square_side_from_area_exact_integer_square_root")
    ...
    for row,evidence in zip(rows,prov):
        ...
        assert "square_side_from_area_exact_integer_square_root_and_recomposition" in evidence["verification_evidence"]
    print("PASS_SQUARE_SIDE_FROM_AREA_UNIFIED_ADAPTER")
