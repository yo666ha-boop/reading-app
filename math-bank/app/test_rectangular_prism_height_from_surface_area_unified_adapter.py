...
def main():
    ...
    parent["id"]="U-RP-H-SA"
    parent["question"]="たて4cm、よこ3cm、表面積94cm²の直方体の高さを求めなさい。"
    parent["answer"]="5cm"
    parent["choices"]=None
    parent["figure_refs"]=[]
    ...
    for row,evidence in zip(rows,prov):
        ...
        assert "rectangular_prism_height_from_surface_area_exact_linear_inverse_and_recomposition" in evidence["verification_evidence"]
    print("PASS_RECTANGULAR_PRISM_HEIGHT_FROM_SURFACE_AREA_UNIFIED_ADAPTER")
