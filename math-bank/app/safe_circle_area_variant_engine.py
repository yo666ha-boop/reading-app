...
def can_generate(parent: dict) -> tuple[bool, str]:
    ...
    for fn in (generate_sector_radius_from_arc_length, generate_sector_angle_from_arc_length, generate_sector_angle_from_area, generate_sector_area, generate_sector_arc_length):
