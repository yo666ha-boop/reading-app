...
def main():
    ...
    parent["id"]="U-SPHERE-R-VOLUME"
    parent["question"]="円周率を3.14とします。体積が113.04cm³の球の半径を求めなさい。"
    parent["answer"]="3cm"; parent["choices"]=None; parent["figure_refs"]=[]
    ...
    assert reason.startswith("specialized:sphere_pi_3_14:sphere_volume_to_integer_radius_pi_3_14_exact")
    ...
    for row,p in zip(rows,prov):
        ...
        assert "sphere_radius_from_volume_exact_division_cube_root_and_recomposition" in p["verification_evidence"]
    print("PASS_SPHERE_RADIUS_FROM_VOLUME_UNIFIED_PARENT_CONTRACT")
