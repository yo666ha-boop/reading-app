...
def main():
    ...
    rows,prov,reason=generate_parent(p,3,NOW); assert reason.startswith("specialized:circle_area:sector_arc_length_pi_3_14_exact_terminating"); assert len(rows)==len(prov)==3
