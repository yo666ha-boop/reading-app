...
if(require.main===module){const out=build();fs.writeFileSync('v11_batch12_final_candidate.json',JSON.stringify(out,null,2)+'\n');console.log(JSON.stringify({passages:out.passages.length,questions:500,registered:out.registered,status:out.status,finalSemanticRepairs:out.finalSemanticRepairs||[],finalSlashHumanReview:out.finalSlashHumanReview||null,grammarRepair:out.grammarRepair||null,grammarRepairR2:out.grammarRepairR2||null},null,2));}
